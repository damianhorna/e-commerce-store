...
<body>
	...
	<div class="container text-center min-hght">
		<form:form action="transaction-complete" method="POST">
			<h3 class="font-bold">Select payment options</h3>
			<input type="submit" class="btn btn-danger" value="Confirmation"/>
		</form:form>
	</div>
	<!-- /.container -->
